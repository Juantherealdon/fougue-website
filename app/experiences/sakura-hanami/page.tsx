...
const carouselImages = [
  { src: "/images/experience-japan.jpg", alt: "Japanese interior" },
  { src: "/images/surprise-hands.jpg", alt: "Intimate moment" },
  { src: "/images/letter-seal.jpg", alt: "Traditional details" },
  { src: "/images/couple-dancing.jpg", alt: "Connection" },
]

const addOns = [
  {
    id: "sake",
    name: "Premium Sake Tasting",
    description: "Selection of three premium Japanese sakes with tasting notes",
    price: 400,
  },
  {
    id: "kimono",
    name: "Traditional Kimono Experience",
    description: "Wear authentic Japanese kimonos during your experience",
    price: 550,
  },
  {
    id: "calligraphy",
    name: "Calligraphy Session",
    description: "Learn to write your names in Japanese calligraphy as a keepsake",
    price: 300,
  },
  {
    id: "bento",
    name: "Kaiseki Bento Upgrade",
    description: "Traditional multi-course Japanese meal in elegant presentation",
    price: 650,
  },
  {
    id: "photographer",
    name: "Photography Session",
    description: "45-minute professional photoshoot in the Japanese setting",
    price: 750,
  },
]
...
const experienceDetails = [
  ...
  { icon: MapPin, label: "Location", value: "Private Japanese sanctuary" },
]
...
const included = [
  {
    icon: Flower2,
    title: "Tea Ceremony",
    description: "Authentic Japanese tea ceremony guided by a tea master",
  },
  {
    icon: Sparkles,
    title: "Sake Pairing",
    description: "Introduction to Japanese sake with three curated selections",
  },
  {
    icon: Wind,
    title: "Zen Setting",
    description: "Immersive Japanese décor with tatami, shoji screens, and ambient sounds",
  },
  {
    icon: Heart,
    title: "Mindful Connection",
    description: "Guided meditation for couples to deepen your bond",
  },
]
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center">
        ...
        >
          Sakura <span className="italic text-[#800913]">Hanami</span>
        </h1>
        <p
        ...
        >
          ...
          <div className="text-white text-center sm:text-left">
            ...
            <p className="text-2xl font-light">AED 2,200</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className={`text-[#1E1E1E] text-4xl md:text-5xl font-light mb-8 transition-all duration-700 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              Journey to <span className="italic text-[#800913]">Kyoto</span>
            </h2>
            <div className={`space-y-6 text-[#1E1E1E]/70 text-lg leading-relaxed transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              <p>
                Step into a world of Japanese tranquility without leaving Dubai. Our Sakura Hanami experience transforms a private space into an authentic Japanese sanctuary, complete with tatami mats, shoji screens, and the gentle sounds of a bamboo water fountain.
              </p>
              <p>
                Begin with a traditional tea ceremony, where every movement carries meaning and the simple act of sharing tea becomes a profound expression of mindfulness and connection. A tea master guides you through this centuries-old ritual, explaining its philosophy of harmony, respect, and tranquility.
              </p>
              <p>
                The experience continues with a sake tasting, where you{"'"}ll discover the subtle complexities of Japan{"'"}s most celebrated drink. End with a guided couples meditation, designed to help you both find presence and deepen your bond in stillness.
              </p>
            </div>
          </div>
          ...
          <div className={`relative aspect-[4/5] transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}>
            <Image src="/images/experience-japan.jpg" alt="Japanese interior" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
            <div className="absolute -bottom-8 -left-8 bg-[#800913] text-white p-8 max-w-[280px]">
              <p className="text-3xl font-light mb-2">{"\""}Zen{"\""}</p>
              <p className="text-white/70 text-sm">A truly transformative experience. We left feeling more connected than ever.</p>
              <p className="text-white/50 text-xs mt-3">— Aisha & Omar</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-white text-4xl md:text-5xl font-light transition-all duration-700 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            A Journey of <span className="italic text-[#800913]">Mindfulness</span>
          </h2>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-[#1E1E1E] text-4xl md:text-5xl font-light transition-all duration-700 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            Moments of <span className="italic text-[#800913]">Serenity</span>
          </h2>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            { src: "/images/experience-japan.jpg", aspect: "aspect-[3/4]" },
            { src: "/images/surprise-hands.jpg", aspect: "aspect-square" },
            { src: "/images/letter-seal.jpg", aspect: "aspect-[3/4] row-span-2" },
            { src: "/images/couple-dancing.jpg", aspect: "aspect-square" },
            { src: "/images/gift-door.jpg", aspect: "aspect-[4/3]" },
          ].map((img, index) => (
            <div
              key={index}
    ...
    <section ref={sectionRef} className="py-24 lg:py-32 bg-white">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-[#1E1E1E] text-4xl md:text-5xl font-light transition-all duration-700 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            A Gift of <span className="italic text-[#800913]">Peace</span>
          </h2>
        </div>
...
function CTASection({ onBookClick }: { onBookClick: () => void }) {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-48 overflow-hidden">
      <div className="absolute inset-0">
        <Image src="/images/experience-japan.jpg" alt="Japanese sanctuary" fill sizes="100vw" className="object-cover" />
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 className={`text-white text-4xl md:text-5xl lg:text-6xl font-light mb-6 transition-all duration-700 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          Ready for Your <span className="italic text-[#800913]">Sakura Hanami</span>?
        </h2>
        <p className={`text-white/70 text-lg md:text-xl leading-relaxed mb-10 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          Step into serenity together. Book your Japanese sanctuary experience today.
        </p>
        <button
          onClick={onBookClick}
...
export default function SakuraHanamiPage() {
