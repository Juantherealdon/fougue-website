  ...
  public: {
    Tables: {
      ...
      experience_included_items: {
        ...
        Insert: Omit<Database['public']['Tables']['experience_included_items']['Row'], 'id' | 'created_at'>
        Update: Partial<Database['public']['Tables']['experience_included_items']['Insert']>
      }
      availability_rules: {
        Row: {
          id: string
        ...
        Insert: Omit<Database['public']['Tables']['availability_rules']['Row'], 'id' | 'created_at' | 'updated_at'>
